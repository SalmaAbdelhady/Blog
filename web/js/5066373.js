...
//Rating Star activator
    if ($('.star').length > 0) {
        if ($('.star.big').length > 0) {
            $('.star').raty({
                space: false,
                starOff: '/bundles/app/images/star-big-off.png',
                starOn: '/bundles/app/images/star-big-on.png',
                score: function() {
            ...
            $('.star').raty({
                space: false,
                starOff: '/bundles/app/images/star-off.png',
                starOn: '/bundles/app/images/star-on.png',
                score: function() {
                    return $(this).attr('data-score');
                }
            });
...
//Google Map Activator
    ...
    function initializeMap(holderID, lang, lat, address) {
        ...
        boxText.style.cssText = "margin-top: 8px; background-color:#5DBCD2; color:#ffffff; padding: 20px;";
